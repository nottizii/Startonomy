...
export class economyManager extends EventEmitter {
    ...
    guildID: string
    userID: string
    data: economyData // estructura pendiente, realizar
    ammount: number
    WoB: string
    oldBal: number
    newBal: number
     ...
     */
    public getData(userID: string, guildID: string):economyData {
     ...
     */
    private _queryDatabase(payload:{guildID:string, userID:string}):Promise<economyData> {
     ...
     */
    public async addBalance(userID: string, guildID: string, ammount: number, WoB?: string): Promise<economyData> {
        return new Promise((res, rej) => {
            ...
            if (!this.depType.includes(WoB) || isNaN(this.ammount) || typeof this.guildID !== 'string' || this.guildID === 'undefined' || this.guildID === null || typeof this.userID !== 'string' || this.userID === 'undefined' || this.userID === null) throw new TypeError('[ERR_BAD_DATA] Data supplied is invalid, please re-check your function parameters')
     ...
     * economyManager.addBalance("573991320897716224", "793292273159766056", 300, wallet)
     */
    async removeBalance(userID: string, guildID: string, ammount: number, WoB: string):Promise<economyData> {
        return new Promise((res, rej) => {
            if (typeof WoB !== 'string') throw new TypeError('[ERR_BAD_DATA] Data supplied is invalid, please re-check your function parameters')
            this.guildID = guildID ?? null
            this.userID = userID ?? null
     ...
     */
    public resetEconomy(userID: string, guildID: string):economyData {
        this.guildID = guildID ?? null
        this.userID = userID ?? null
        if (typeof this.guildID !== 'string' || this.guildID === 'undefined' || this.guildID === null || typeof this.userID !== 'string' || this.userID === 'undefined' || this.userID === null) throw new TypeError('[ERR_BAD_DATA] Data supplied is invalid, please re-check your function parameters')
        this.connection.getConnection((err, con) => {
     ...
     * @returns { null }
     */
    public registerguild(guildID: string):null {
        this.guildID = guildID ?? null
        ...
        this.connection.getConnection((err, con) => {
            con.query(`CREATE TABLE IF NOT EXISTS data_${this.guildID} (id varchar(18) CHARACTER SET utf8 DEFAULT 'No id', bank varchar(9) CHARACTER SET utf8 DEFAULT '0',  wallet varchar(9) CHARACTER SET utf8 DEFAULT '0', unlimited int(5) CHARACTER SET utf8 DEFAULT 'false') ENGINE=InnoDB DEFAULT CHARSET=latin1`, (err) => { if (err) throw err })
            con.release();
        })
        return null;
    }
     ...
     */
    public registerUser(userID: string, guildID: string):null {
        this.userID = userID ?? null
        this.guildID = guildID ?? null
        if (typeof this.guildID !== 'string' || this.guildID === 'undefined' || this.guildID === null || typeof this.userID !== 'string' || this.userID === 'undefined' || this.userID === null) throw new TypeError('[ERR_BAD_DATA] Data supplied is invalid, please re-check your function parameters')
        this.connection.getConnection((err, con) => {
     ...
     */
    public unregisterGuild(guildID: string):string {
        this.guildID = guildID ?? null
     ...
     * @public
     */
    public unregisterUser(userID: string, guildID: string) {
        this.userID = userID ?? null
        this.guildID = guildID ?? null
        if (typeof this.guildID !== 'string' || this.guildID === 'undefined' || this.guildID === null || typeof this.userID !== 'string' || this.userID === 'undefined' || this.userID === null) throw new TypeError('[ERR_BAD_DATA] Data supplied is invalid, please re-check your function parameters')
        this.connection.getConnection((err, con) => {
